...
export default function ProjectPage() {
  ...
  const projects = {
    ...
    "digital-twins": {
      ...
      description:
        "Machine learning analysis of behavioral patterns using smartwatch data to create digital twin models.",
      image: "/digiTwin.png",
      technologies: ["Python", "Jupyter Notebook", "Sklearn"],
      category: "AI/ML",
      github: "https://github.com/Ctt011/Capstone-Behavorial/blob/main/WISE_Stress_EDA_Model.ipynb",
      longDescription:
        "This capstone project explores the creation of digital twin models using behavioral data collected from smartwatches. By analyzing patterns in activity, heart rate, sleep, and other biometric data, the system builds predictive models that can simulate and forecast individual behavior patterns. Using Python for data processing, Jupyter Notebook for exploratory analysis, and Sklearn for machine learning implementation, this project demonstrates how wearable technology data can be transformed into actionable insights. The digital twin approach allows for personalized health recommendations, behavior prediction, and lifestyle optimization based on continuous monitoring of physiological and activity metrics.",
    },
  }
